...
CREATE TABLE IF NOT EXISTS leases (
    ...
    runtime_control_executable_sha256 TEXT NOT NULL,
    control_pid INTEGER,
...
class LeaseRow:
    ...
    runtime_control_executable_sha256: str
    ...
    def runtime_identity(self) -> BrowserRuntimeIdentity:
        return BrowserRuntimeIdentity(
            ...
            control_executable_sha256=self.runtime_control_executable_sha256,
        )
    ...
    def safe_data(self) -> dict[str, object]:
        ...
        data["runtime_generation"] = self.runtime_generation
        return data
    ...
    def _row(value: sqlite3.Row | None) -> LeaseRow:
        ...
        try:
            row = LeaseRow(
                ...
                runtime_control_executable_sha256=value["runtime_control_executable_sha256"],
        ...
        try:
            ...
            connection.execute(
                ...
                INSERT INTO leases(
                    ...
                    runtime_generation, runtime_executable, runtime_executable_sha256,
                    runtime_control_executable, runtime_control_executable_sha256
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """,
                (
                    lease_id,
                    ...
                    runtime_identity.control_executable_sha256,
                ),
            )
            connection.commit()
